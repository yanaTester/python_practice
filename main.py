...
# этого шифра. В первой строке дается число n, (1≤ n≤ 25) – сдвиг, во второй строке даётся закодированное сообщение в виде
# строки со строчными латинскими буквами. Тест.данные:
# 1) 1 bwfusvfupdbftbs avetruetocaesar
# 2) 14 fsfftsfufksttskskt rerrfergrweffewewf
# 3) 25 jjjjjjj kkkkkkk
